...
public class MOBGeorgeNotFoundEntity extends MemeDimensionModModElements.ModElement {
	public static EntityType entity = null;
	public MOBGeorgeNotFoundEntity(MemeDimensionModModElements instance) {
		super(instance, 20);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("mob_george_not_found")
						.setRegistryName("mob_george_not_found");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -16711681, -13369600, new Item.Properties().group(SlimecicleItemGroup.tab))
				.setRegistryName("mob_george_not_found_spawn_egg"));
	}
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("meme_dimension_mod:textures/george.png");
					}
				};
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(10, new BreedGoal(this, 4));
		}
		...
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("meme_dimension_mod:george_scream"));
		}
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (new ItemStack(Items.CLAY_BALL, (int) (1)).getItem() == stack.getItem())
				return true;
			if (new ItemStack(Items.DIAMOND, (int) (1)).getItem() == stack.getItem())
				return true;
			return false;
		}
	}
