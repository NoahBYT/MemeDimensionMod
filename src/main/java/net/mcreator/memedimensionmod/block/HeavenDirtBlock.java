...
public class HeavenDirtBlock extends MemeDimensionModModElements.ModElement {
	@ObjectHolder("meme_dimension_mod:heaven_dirt")
	public static final Block block = null;
	public HeavenDirtBlock(MemeDimensionModModElements instance) {
		super(instance, 30);
	}
