...
import net.mcreator.memedimensionmod.procedures.GlowSaplingUpdateTickProcedure;
import net.mcreator.memedimensionmod.procedures.GlowSaplingPlantRightClickedProcedure;
import net.mcreator.memedimensionmod.procedures.GlowSaplingPlantAddedProcedure;
...
public class GlowSaplingBlock extends MemeDimensionModModElements.ModElement {
	@ObjectHolder("meme_dimension_mod:glow_sapling")
	public static final Block block = null;
	public GlowSaplingBlock(MemeDimensionModModElements instance) {
		super(instance, 49);
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			int z = pos.getZ();
			{
				...
				GlowSaplingPlantAddedProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				GlowSaplingUpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				GlowSaplingPlantRightClickedProcedure.executeProcedure($_dependencies);
			}
