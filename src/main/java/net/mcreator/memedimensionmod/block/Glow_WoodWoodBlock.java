...
public class Glow_WoodWoodBlock extends MemeDimensionModModElements.ModElement {
	@ObjectHolder("meme_dimension_mod:glow_wood_wood")
	public static final Block block = null;
	public Glow_WoodWoodBlock(MemeDimensionModModElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("glow_wood_wood");
		}
