...
public class Glow_WoodSlabBlock extends MemeDimensionModModElements.ModElement {
	@ObjectHolder("meme_dimension_mod:glow_wood_slab")
	public static final Block block = null;
	public Glow_WoodSlabBlock(MemeDimensionModModElements instance) {
		super(instance, 38);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("glow_wood_slab");
		}
