...
public class Glow_WoodFenceGateBlock extends MemeDimensionModModElements.ModElement {
	@ObjectHolder("meme_dimension_mod:glow_wood_fence_gate")
	public static final Block block = null;
	public Glow_WoodFenceGateBlock(MemeDimensionModModElements instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("glow_wood_fence_gate");
		}
