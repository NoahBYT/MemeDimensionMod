...
public class Glow_WoodStairsBlock extends MemeDimensionModModElements.ModElement {
	@ObjectHolder("meme_dimension_mod:glow_wood_stairs")
	public static final Block block = null;
	public Glow_WoodStairsBlock(MemeDimensionModModElements instance) {
		super(instance, 37);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("glow_wood_stairs");
		}
