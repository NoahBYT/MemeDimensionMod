...
public class GrassyAssBlock extends MemeDimensionModModElements.ModElement {
	@ObjectHolder("meme_dimension_mod:grassy_ass")
	public static final Block block = null;
	public GrassyAssBlock(MemeDimensionModModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("*smells* hmmm smells like some great grassy ass."));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(DirtyAssBlock.block, (int) (1)));
		}
	}
}
