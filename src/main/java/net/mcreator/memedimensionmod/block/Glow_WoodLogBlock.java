...
public class Glow_WoodLogBlock extends MemeDimensionModModElements.ModElement {
	@ObjectHolder("meme_dimension_mod:glow_wood_log")
	public static final Block block = null;
	public Glow_WoodLogBlock(MemeDimensionModModElements instance) {
		super(instance, 34);
	}
