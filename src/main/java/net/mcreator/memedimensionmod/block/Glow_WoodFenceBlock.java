...
public class Glow_WoodFenceBlock extends MemeDimensionModModElements.ModElement {
	@ObjectHolder("meme_dimension_mod:glow_wood_fence")
	public static final Block block = null;
	public Glow_WoodFenceBlock(MemeDimensionModModElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("glow_wood_fence");
		}
