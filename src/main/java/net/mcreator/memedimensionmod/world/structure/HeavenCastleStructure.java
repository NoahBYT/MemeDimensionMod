...
package net.mcreator.memedimensionmod.world.structure;
...
public class HeavenCastleStructure extends MemeDimensionModModElements.ModElement {
	public HeavenCastleStructure(MemeDimensionModModElements instance) {
		super(instance, 25);
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("meme_dimension_mod:heavenbiome").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
				...
				if ((random.nextInt(1000000) + 1) <= 800) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = world.getWorld().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("meme_dimension_mod", "heaven_castle"));
						if (template == null)
							return false;
